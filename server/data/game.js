export const gamesData = [
  ...
  },
  {
    ...
    trusted friends.  Each object imparts a difference power to its owner (one
  ...
  {
    id: 3,
    title: "The Architecture Grants",
    description: `After working on blueprints for many long hours, five architects
    were thrilled to hear that they had each been awarded a grant for a different
    amount of money ($1000, $2000, $3000, $4000, or $5000). Each architect
    received the grant to work on a different project (including a condominium
